...
//       // expected: { token: "...", role: "...", approved: true/false }
...
//       // optional redirect if approval pending
...
export default function AdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const token = res.data?.token;
      const role = res.data?.role; // backend sends role like ADMIN/STUDENT/TRAINER/BUSINESS
      ...
      // ✅ Save role also (important for RoleGuard)
      if (role) {
